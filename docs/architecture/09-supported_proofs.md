...
| **Noir UltraHonk**  | Noir ≥ v1.0.0-beta.14, bb ≥ v3.0.0 and bb.js ≥ v3.0.0, both ZK and non-ZK variants, Keccak256 only                 | **Public Inputs:** 32, **Max Evaluation Domain Size:** $2^{25}$                                                                                |
| **Noir UltraPlonk**  | Noir ≥ v0.31.0, bb ≤ v0.76.4                  | **Public Inputs:** 32                                                                                  |
