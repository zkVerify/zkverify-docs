...
| **Noir UltraHonk**  | Noir ≥ v1.0.0-beta.14, bb ≥ v3.0.0 and bb.js ≥ v3.0.0, both ZK and non-ZK variants, Keccak256 only. Submission variants: `V0_84`, `V3_0`, and `Legacy` (backward-compatible alias for `V0_84` that reproduces the pre-versioning statement hash). | **Max number of Public Inputs:** 32, **Max Evaluation Domain Size:** $2^{25}$                                                                                |
...
| **TEE**              | Intel TDX, AWS Nitro                   | **Max Proof Size:** 8192 bytes, **Max VK Size:** 8192 bytes per field, **Public Inputs:** none         |
