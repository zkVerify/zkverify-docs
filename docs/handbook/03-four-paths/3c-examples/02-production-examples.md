...
1) whether your proof carries uniqueness or action semantics;
2) whether the verification result is persisted well enough to audit and reuse;
3) whether your consumption logic separates “verification succeeded” from “business action completed.”
