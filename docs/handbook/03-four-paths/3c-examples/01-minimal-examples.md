...
sidebar_position: 2
---
This page gives three small examples that make the verification loop visible end to end. They are intentionally narrow: enough to see the inputs, proof shape, verification result, and, when relevant, the role of aggregation.

Each example answers the same engineering questions:
...
These five steps are the part worth reusing. When an example fails, they also give you a clean place to ask which stage broke.
...
After you run these three examples, the next section shows how the same structure changes once you add replay protection, persistence, and action binding.
