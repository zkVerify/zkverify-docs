...
sidebar_position: 5
---
This page collects four beginner questions that come up repeatedly in real integrations. It is meant to help you make the right engineering choice quickly, not to serve as a full encyclopedia. Each question is organized as “scenario → choice → consequence” so you can scan it fast.
