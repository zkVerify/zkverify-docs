...
sidebar_position: 3
---
This page explains what to do after verification succeeds. You can consume results on the Web2 side or on the contract side. The key distinction is not “whether verification succeeded,” but “where you record the result and who is expected to trust it.”
