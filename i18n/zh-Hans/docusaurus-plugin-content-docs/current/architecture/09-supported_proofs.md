...
| **Groth16**          | BLS12-381, BN128, BN254            | **Public Inputs:** 64                                                                                  |
| **Noir UltraHonk**  | Noir v1.0.0-beta.6, v0.84.0 \<\= bb \< v0.86.* and 0.84.0 \<\= bb.js \< v0.86.*, both ZK and non-ZK variants, Keccak256 only. Submission variants: `V0_84`, `V3_0`, and `Legacy` (backward-compatible alias for `V0_84` that reproduces the pre-versioning statement hash).                 | **Public Inputs:** 32                                                                                  |
